...
def load_abs_parser(uid):
	...
	if(xas_abs.encoder_file != encoder_file or xas_abs.i0_file != ion_file or xas_abs.it_file != ion_file2):
		print('Parsing abs files...')
		xas_abs.load(encoder_file, ion_file, ion_file2)
		xas_abs.interpolate()
...
def load_flu_parser(uid):
	...
	if(xas_flu.encoder_file != encoder_file or xas_flu.i0_file != ion_file or xas_flu.it_file != ion_file2):
		print('Parsing flu files...')
		xas_flu.load(encoder_file, ion_file, ion_file2)
		xas_flu.interpolate()
...
def plot_abs_files(ion_file, ion_file2, encoder_file, color='r'):
